function [ A1,A2,X,alpha1,alpha2 ] = multiplicative_update( Y1,Y2,A1,A2,X,alpha1,alpha2,lambda1,lambda2,lambda3,lambda4,lambda5)
...
X = X.*((A1'*Y1 + A2'*Y2)./(lambda3*X + A1'*A1*X + A2'*A2*X + A1'*alpha1*ones(t,1)' + A2'*alpha2*ones(t,1)'));
