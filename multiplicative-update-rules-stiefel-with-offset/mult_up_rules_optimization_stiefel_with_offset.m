function [A1,A2,X,alpha1,alpha2,error] = mult_up_rules_optimization_stiefel_with_offset( Y1,Y2,A1,A2,X,alpha1,alpha2,lambda1,lambda2,lambda3,lambda4,lambda5,max_it)
...
for it = 1 : max_it
    [A1,A2,X,alpha1,alpha2] = multiplicative_update_stiefel_with_offset( Y1,Y2,A1,A2,X,alpha1,alpha2,lambda1,lambda2,lambda3,lambda4,lambda5);
